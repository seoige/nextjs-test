        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              fetch('https://api.unsplash.com/photos/?client_id=' + key).then(function (res) {
                return res.json();
              }).then(function (data) {
                console.log(data[0].urls.full);
                var img = data[0].urls.full;
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(Weatherwidget, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement("div", {
        ...
        src: "https://images.unsplash.com/photo-1557223146-2df1a50b57e3?ixlib=rb-1.2.1&q=85&fm=jpg&crop=entropy&cs=srgb&ixid=eyJhcHBfaWQiOjcwNzg2fQ",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 33
        },
...
//# sourceMappingURL=index.js.277114dac7c97a7f43a4.hot-update.js.map